...
from daily_fantasy_sports_scoring_calculators.draft_kings.nfl.scoring.calculators.game_types.classic.defensive \
    import points_calculator
from daily_fantasy_sports_scoring_calculators.draft_kings.nfl.statistics.models.defensive \
    import BlockedKickReturnTouchdownStatistics, \
